...
public class MobilityPathParserTest {
	...
	private CellSpan makeCellSpan(int personCode, double cellCode, int startInMinutes,
			int endInMinutes) {
	...
	public void testPaper() {
		...
		spans.add(makeCellSpan(1, 1.1, 0, 4));
		spans.add(makeCellSpan(1, 1.2, 6, 9));
		spans.add(makeCellSpan(1, 1.3, 9, 13));
		spans.add(makeCellSpan(1, 1.5, 15, 23));
		spans.add(makeCellSpan(1, 1.3, 23, 27));
		spans.add(makeCellSpan(1, 1.1, 27, 30));
		spans.add(makeCellSpan(1, 1.2, 41, 45));
		spans.add(makeCellSpan(1, 1.3, 49, 50));
		spans.add(makeCellSpan(1, 1.1, 56, 58));
		spans.add(makeCellSpan(1, 1.3, 58, 61));
		spans.add(makeCellSpan(1, 1.4, 63, 66));
